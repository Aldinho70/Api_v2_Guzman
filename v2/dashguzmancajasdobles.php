...
/* =========================
   ORDENAMIENTO
========================= */
usort($cajasSinReporte, fn($a, $b) => $b['Timestamp'] <=> $a['Timestamp']);

/* =========================
   ENVÍO INTERCEPTOR
========================= */
$responses = [];
$responses[] = sendJson('json_arrcajasd.json', $cajasSinReporte);
...
echo json_encode([
    'status'   => 'finished',
    'archivo'  => 'json_arrcajasd.json',
    'total'    => count($cajasSinReporte),
    'respuesta'=> $responses
